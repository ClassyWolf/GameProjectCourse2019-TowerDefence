...
public class MageTower : MonoBehaviour
{
    ...
    void Shoot()
    {
        soundManager.PlayEfx(4);
        GameObject ammoGO = (GameObject)Instantiate(ammoPrefab, firePoint.position, firePoint.rotation);
        MageAmmo ammo = ammoGO.GetComponent<MageAmmo>();
